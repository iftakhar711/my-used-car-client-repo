...
const Signup = () => {
    ...
    return (
        <div className=' flex sm:flex-col md:flex-row lg:flex-row justify-center items-center'>
            <div>
                <img className=' w-[500px] h-[470px]' src={signinimage} alt="" />
            </div>
                ...
                <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
                    ...
                    >
                        ...
                        <div className='space-y-2'>
                            <div>
                                <button className='w-full px-8 py-3 font-semibold rounded-md bg-gray-900 hover:bg-gray-600 hover:text-white text-gray-100'>
